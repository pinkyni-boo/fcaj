...
* Complete the simulated login, role-based access flow, and document contribution experience.
* Build a moderation workflow that matches the student upload and admin approval use case.
* Prepare the foundation for the admin dashboard and future document management actions.
...
* The CloudDoc user journey became much clearer and better aligned with student and admin roles.
* The upload and moderation process was fully modeled and ready for backend integration.
* Frontend and backend direction became more consistent around document data, status flow, and required endpoints.
